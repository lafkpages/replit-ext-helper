...
export { type ReplitExtHelper };
class ReplitExtHelper extends EventTarget {
  debug = false;
  ...
  protected _forceDesktop = false;

  protected _queries: Record<string, Query> = {
    ...
    "sidebar-bottom-links": [{ init: "sidebar", query: ".sidebar-bottom ul" }],
    "sidebar-bottom-link": [
      {
